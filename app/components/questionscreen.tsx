        ...
        <div className="flex flex-col flex-auto mt-20 text-center">
          <div className="flex flex-auto">
            <AnswerButton
              ...
              callback={(event: any) => {props.setSelectedIndex(0)}}>
              {props.answers[0]}
            </AnswerButton>
            <AnswerButton 
              color="bg-blue-300"
              ...
              id={1 as number}
              selected={props.selectedIndex}
              callback={(event: any) => {props.setSelectedIndex(1)}}>
              {props.answers[1]}
            </AnswerButton>
          </div>
          <div className="flex flex-auto">
            <AnswerButton
              ...
              id={2 as number}
              selected={props.selectedIndex}
              callback={(event: any) => {props.setSelectedIndex(2)}}>
              {props.answers[2]}
            </AnswerButton>
            <AnswerButton
              color="bg-purple-300"
              ...
              id={3 as number}
              selected={props.selectedIndex}
              callback={(event: any) => {props.setSelectedIndex(3)}}>
              {props.answers[3]}
            </AnswerButton>
          </div>
        </div>
